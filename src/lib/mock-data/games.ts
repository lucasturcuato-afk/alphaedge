...
const NBA_TIME = new Date().toISOString().slice(0,10) + "T21:00:00.000Z";
const NCAA_TIME_1 = new Date().toISOString().slice(0,10) + "T21:10:00.000Z";
const NCAA_TIME_2 = new Date().toISOString().slice(0,10) + "T21:30:00.000Z";
const NCAA_TIME_3 = new Date().toISOString().slice(0,10) + "T23:45:00.000Z";
const NCAA_TIME_4 = new Date().toISOString().slice(0,10) + "T00:05:00.000Z";
const MLB_1030 = new Date().toISOString().slice(0,10) + "T15:15:00.000Z";
const MLB_1110 = new Date().toISOString().slice(0,10) + "T16:10:00.000Z";
const MLB_1120 = new Date().toISOString().slice(0,10) + "T16:20:00.000Z";
const MLB_1205 = new Date().toISOString().slice(0,10) + "T17:05:00.000Z";
const MLB_110  = new Date().toISOString().slice(0,10) + "T18:10:00.000Z";
const MLB_115  = new Date().toISOString().slice(0,10) + "T18:15:00.000Z";
const MLB_530  = new Date().toISOString().slice(0,10) + "T22:30:00.000Z";
const MLB_710  = new Date().toISOString().slice(0,10) + "T00:10:00.000Z";
...
export const MOCK_GAMES: Game[] = [
...

  {
    ...
    lines: [
      { sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 222.5, homeML: -140, awayML: 118, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
      { sportsbook: "FanDuel",    homeSpread: -1.5, awaySpread: 1.5, total: 222.5, homeML: -142, awayML: 120, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
      { sportsbook: "BetMGM",    homeSpread: -2.0, awaySpread: 2.0, total: 223.0, homeML: -145, awayML: 122, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
    ],
    prediction: {
      ...
      createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z",
    },
    simulation: {
...

  {
    ...
    lines: [
      { sportsbook: "DraftKings", homeSpread: -3.5, awaySpread: 3.5, total: 226.5, homeML: -195, awayML: 162, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
      { sportsbook: "FanDuel",    homeSpread: -3.5, awaySpread: 3.5, total: 226.5, homeML: -192, awayML: 160, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
      { sportsbook: "BetMGM",    homeSpread: -4.0, awaySpread: 4.0, total: 227.0, homeML: -200, awayML: 165, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
    ],
    prediction: {
...

  {
    ...
    lines: [
      { sportsbook: "DraftKings", homeSpread: -15.5, awaySpread: 15.5, total: 230.5, homeML: -900, awayML: 600, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
      { sportsbook: "FanDuel",    homeSpread: -15.5, awaySpread: 15.5, total: 230.5, homeML: -880, awayML: 590, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" },
    ],
    prediction: {
...

  {
    ...
    lines: [{ sportsbook: "DraftKings", homeSpread: -7.5, awaySpread: 7.5, total: 147.5, homeML: -320, awayML: 260, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" }],
    prediction: {
...

  {
    ...
    lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 131.5, homeML: -130, awayML: 110, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" }],
    prediction: {
...

  {
    ...
    lines: [{ sportsbook: "DraftKings", homeSpread: -7.5, awaySpread: 7.5, total: 164.5, homeML: -320, awayML: 260, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" }],
    prediction: {
...

  {
    ...
    lines: [{ sportsbook: "DraftKings", homeSpread: -2.5, awaySpread: 2.5, total: 140.5, homeML: -148, awayML: 124, timestamp: new Date().toISOString().slice(0,10) + "T15:00:00.000Z" }],
    prediction: {
  ...
  { id: "mlb-pit-nym", sport: "MLB", awayTeam: { id: "pit", name: "Pittsburgh Pirates", shortName: "Pirates", abbreviation: "PIT", city: "Pittsburgh", sport: "MLB" }, homeTeam: { id: "nym", name: "New York Mets", shortName: "Mets", abbreviation: "NYM", city: "New York", sport: "MLB" }, gameTime: MLB_1030, status: "scheduled", venue: "Citi Field, Queens NY", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 8.0, homeML: -131, awayML: 109, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-pit-nym", gameId: "mlb-pit-nym", modelVersion: "v2.1", predictedWinner: "nym", winProbHome: 0.57, winProbAway: 0.43, projectedTotal: 8.2, projectedSpread: -0.9, confidenceScore: 57, fairOddsHome: -133, fairOddsAway: 111, edgeHome: 0.8, edgeAway: -0.6, supportingFactors: [{ label: "NYM Home Edge", impact: "medium", direction: "positive", value: "Citi Field", description: "Mets are modest favorites at home" }], riskFactors: [], reasoning: "Mets -131 at home vs Pirates. Model aligns. Near push.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-chw-mil", sport: "MLB", awayTeam: { id: "chw", name: "Chicago White Sox", shortName: "White Sox", abbreviation: "CHW", city: "Chicago", sport: "MLB" }, homeTeam: { id: "mil", name: "Milwaukee Brewers", shortName: "Brewers", abbreviation: "MIL", city: "Milwaukee", sport: "MLB" }, gameTime: MLB_1110, status: "scheduled", venue: "American Family Field, Milwaukee WI", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 7.5, homeML: -186, awayML: 153, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-chw-mil", gameId: "mlb-chw-mil", modelVersion: "v2.1", predictedWinner: "mil", winProbHome: 0.65, winProbAway: 0.35, projectedTotal: 7.4, projectedSpread: -1.8, confidenceScore: 64, fairOddsHome: -186, fairOddsAway: 152, edgeHome: 0.1, edgeAway: -0.1, supportingFactors: [{ label: "CHW Rebuilding", impact: "high", direction: "positive", value: "White Sox in full rebuild", description: "Milwaukee should handle rebuilding White Sox at home" }], riskFactors: [], reasoning: "MIL -186 is fair. Slight UNDER lean at 7.4 vs 7.5.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-wsh-chc", sport: "MLB", awayTeam: { id: "wsh", name: "Washington Nationals", shortName: "Nationals", abbreviation: "WSH", city: "Washington", sport: "MLB" }, homeTeam: { id: "chc", name: "Chicago Cubs", shortName: "Cubs", abbreviation: "CHC", city: "Chicago", sport: "MLB" }, gameTime: MLB_1120, status: "scheduled", venue: "Wrigley Field, Chicago IL", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 8.5, homeML: -252, awayML: 203, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-wsh-chc", gameId: "mlb-wsh-chc", modelVersion: "v2.1", predictedWinner: "chc", winProbHome: 0.72, winProbAway: 0.28, projectedTotal: 8.8, projectedSpread: -2.1, confidenceScore: 66, fairOddsHome: -257, fairOddsAway: 209, edgeHome: 0.3, edgeAway: 0.8, supportingFactors: [{ label: "Cubs Wrigley Dominance", impact: "high", direction: "positive", value: "CHC -252 massive favorite", description: "Chicago massive favorites vs rebuilding Nationals at Wrigley" }], riskFactors: [], reasoning: "CHC -252 confirmed. Slight OVER lean (8.8 vs 8.5).", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-min-bal", sport: "MLB", awayTeam: { id: "min", name: "Minnesota Twins", shortName: "Twins", abbreviation: "MIN", city: "Minneapolis", sport: "MLB" }, homeTeam: { id: "bal", name: "Baltimore Orioles", shortName: "Orioles", abbreviation: "BAL", city: "Baltimore", sport: "MLB" }, gameTime: MLB_1205, status: "scheduled", venue: "Oriole Park at Camden Yards, Baltimore MD", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 8.0, homeML: -156, awayML: 129, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-min-bal", gameId: "mlb-min-bal", modelVersion: "v2.1", predictedWinner: "bal", winProbHome: 0.61, winProbAway: 0.39, projectedTotal: 8.1, projectedSpread: -1.2, confidenceScore: 60, fairOddsHome: -156, fairOddsAway: 128, edgeHome: 0.1, edgeAway: 0.0, supportingFactors: [{ label: "BAL Home Edge", impact: "medium", direction: "positive", value: "Camden Yards", description: "Orioles solid at home" }], riskFactors: [], reasoning: "BAL -156 is fair value. Near push on the line.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-bos-cin", sport: "MLB", awayTeam: { id: "bos-mlb", name: "Boston Red Sox", shortName: "Red Sox", abbreviation: "BOS", city: "Boston", sport: "MLB" }, homeTeam: { id: "cin", name: "Cincinnati Reds", shortName: "Reds", abbreviation: "CIN", city: "Cincinnati", sport: "MLB" }, gameTime: MLB_110, status: "scheduled", venue: "Great American Ball Park, Cincinnati OH", lines: [{ sportsbook: "DraftKings", homeSpread: 1.5, awaySpread: -1.5, total: 8.5, homeML: 129, awayML: -156, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-bos-cin", gameId: "mlb-bos-cin", modelVersion: "v2.1", predictedWinner: "bos-mlb", winProbHome: 0.42, winProbAway: 0.58, projectedTotal: 8.7, projectedSpread: -1.3, confidenceScore: 59, fairOddsHome: 138, fairOddsAway: -163, edgeHome: 0.6, edgeAway: -0.4, supportingFactors: [{ label: "BOS Road Favorite", impact: "medium", direction: "positive", value: "-156 road", description: "Red Sox are the better team as road favorites" }], riskFactors: [], reasoning: "BOS road favorite confirmed. GABP is a hitter's park — slight OVER lean.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-laa-hou", sport: "MLB", awayTeam: { id: "laa", name: "Los Angeles Angels", shortName: "Angels", abbreviation: "LAA", city: "Anaheim", sport: "MLB" }, homeTeam: { id: "hou-mlb", name: "Houston Astros", shortName: "Astros", abbreviation: "HOU", city: "Houston", sport: "MLB" }, gameTime: MLB_110, status: "scheduled", venue: "Daikin Park, Houston TX", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 8.0, homeML: -186, awayML: 153, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-laa-hou", gameId: "mlb-laa-hou", modelVersion: "v2.1", predictedWinner: "hou-mlb", winProbHome: 0.65, winProbAway: 0.35, projectedTotal: 7.8, projectedSpread: -1.9, confidenceScore: 63, fairOddsHome: -186, fairOddsAway: 152, edgeHome: 0.1, edgeAway: -0.1, supportingFactors: [{ label: "HOU vs Rebuilding LAA", impact: "high", direction: "positive", value: "Angels in rebuild", description: "Houston dominates at home vs rebuilding Angels" }], riskFactors: [], reasoning: "HOU -186 confirmed. Slight UNDER lean 7.8 vs 8.0.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-det-sd", sport: "MLB", awayTeam: { id: "det-mlb", name: "Detroit Tigers", shortName: "Tigers", abbreviation: "DET", city: "Detroit", sport: "MLB" }, homeTeam: { id: "sd", name: "San Diego Padres", shortName: "Padres", abbreviation: "SD", city: "San Diego", sport: "MLB" }, gameTime: MLB_110, status: "scheduled", venue: "Petco Park, San Diego CA", lines: [{ sportsbook: "DraftKings", homeSpread: 1.5, awaySpread: -1.5, total: 7.5, homeML: 113, awayML: -136, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-det-sd", gameId: "mlb-det-sd", modelVersion: "v2.1", predictedWinner: "det-mlb", winProbHome: 0.45, winProbAway: 0.55, projectedTotal: 7.4, projectedSpread: -1.1, confidenceScore: 58, fairOddsHome: 122, fairOddsAway: -145, edgeHome: 1.3, edgeAway: -0.7, supportingFactors: [{ label: "DET Road Favorite", impact: "medium", direction: "positive", value: "-136 road", description: "Tigers as road favorites at pitcher-friendly Petco" }], riskFactors: [], reasoning: "DET -136 road favorite. Petco suppresses scoring — UNDER lean.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-tex-phi", sport: "MLB", awayTeam: { id: "tex-mlb", name: "Texas Rangers", shortName: "Rangers", abbreviation: "TEX", city: "Dallas", sport: "MLB" }, homeTeam: { id: "phi", name: "Philadelphia Phillies", shortName: "Phillies", abbreviation: "PHI", city: "Philadelphia", sport: "MLB" }, gameTime: MLB_115, status: "scheduled", venue: "Citizens Bank Park, Philadelphia PA", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 8.5, homeML: -163, awayML: 135, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-tex-phi", gameId: "mlb-tex-phi", modelVersion: "v2.1", predictedWinner: "phi", winProbHome: 0.62, winProbAway: 0.38, projectedTotal: 8.8, projectedSpread: -1.6, confidenceScore: 62, fairOddsHome: -163, fairOddsAway: 134, edgeHome: 0.1, edgeAway: -0.1, supportingFactors: [{ label: "PHI Home Crowd", impact: "medium", direction: "positive", value: "Citizens Bank Park", description: "Phillies fans are fierce — rowdy home crowd advantage" }], riskFactors: [], reasoning: "PHI -163 confirmed. Citizens Bank can produce offense — slight OVER lean.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-tb-stl", sport: "MLB", awayTeam: { id: "tb", name: "Tampa Bay Rays", shortName: "Rays", abbreviation: "TB", city: "Tampa Bay", sport: "MLB" }, homeTeam: { id: "stl", name: "St. Louis Cardinals", shortName: "Cardinals", abbreviation: "STL", city: "St. Louis", sport: "MLB" }, gameTime: MLB_115, status: "scheduled", venue: "Busch Stadium, St. Louis MO", lines: [{ sportsbook: "DraftKings", homeSpread: 1.5, awaySpread: -1.5, total: 7.5, homeML: 104, awayML: -126, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-tb-stl", gameId: "mlb-tb-stl", modelVersion: "v2.1", predictedWinner: "tb", winProbHome: 0.48, winProbAway: 0.52, projectedTotal: 7.6, projectedSpread: -0.6, confidenceScore: 55, fairOddsHome: 108, fairOddsAway: -128, edgeHome: 0.5, edgeAway: -0.2, supportingFactors: [{ label: "TB Slight Road Edge", impact: "low", direction: "positive", value: "-126 road", description: "Rays modest road favorites" }], riskFactors: [{ label: "STL +104 Value", impact: "low", direction: "negative", value: "Cards at home slightly undervalued", description: "STL at +104 has marginal positive EV at home" }], reasoning: "Pure coin flip. TB -126 vs STL +104. STL at home has marginal EV.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-ari-lad", sport: "MLB", awayTeam: { id: "ari", name: "Arizona Diamondbacks", shortName: "Diamondbacks", abbreviation: "ARI", city: "Phoenix", sport: "MLB" }, homeTeam: { id: "lad", name: "Los Angeles Dodgers", shortName: "Dodgers", abbreviation: "LAD", city: "Los Angeles", sport: "MLB" }, gameTime: MLB_530, status: "scheduled", venue: "Dodger Stadium, Los Angeles CA", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 8.5, homeML: -286, awayML: 229, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-ari-lad", gameId: "mlb-ari-lad", modelVersion: "v2.1", predictedWinner: "lad", winProbHome: 0.74, winProbAway: 0.26, projectedTotal: 8.3, projectedSpread: -2.4, confidenceScore: 68, fairOddsHome: -285, fairOddsAway: 232, edgeHome: 0.1, edgeAway: 0.7, supportingFactors: [{ label: "LAD Dodger Stadium", impact: "high", direction: "positive", value: "-286 massive favorite", description: "Los Angeles is a powerhouse at home with deep rotation and lineup" }], riskFactors: [{ label: "ARI +229 Upset History", impact: "medium", direction: "negative", value: "ARI beat LAD in playoffs", description: "Arizona has beaten LA in recent postseasons — never fully dismiss them" }], reasoning: "Dodgers massive -286 home favorites confirmed. UNDER 8.5 lean at 8.3 projection. ARI +229 has tiny positive model edge.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
  { id: "mlb-cle-sea", sport: "MLB", awayTeam: { id: "cle", name: "Cleveland Guardians", shortName: "Guardians", abbreviation: "CLE", city: "Cleveland", sport: "MLB" }, homeTeam: { id: "sea", name: "Seattle Mariners", shortName: "Mariners", abbreviation: "SEA", city: "Seattle", sport: "MLB" }, gameTime: MLB_710, status: "scheduled", venue: "T-Mobile Park, Seattle WA", lines: [{ sportsbook: "DraftKings", homeSpread: -1.5, awaySpread: 1.5, total: 7.5, homeML: -199, awayML: 159, timestamp: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" }], prediction: { id: "pred-cle-sea", gameId: "mlb-cle-sea", modelVersion: "v2.1", predictedWinner: "sea", winProbHome: 0.67, winProbAway: 0.33, projectedTotal: 7.2, projectedSpread: -2.1, confidenceScore: 65, fairOddsHome: -203, fairOddsAway: 166, edgeHome: 0.3, edgeAway: 1.0, supportingFactors: [{ label: "T-Mobile Park Pitcher's Park", impact: "high", direction: "positive", value: "Best UNDER park in MLB", description: "T-Mobile Park consistently suppresses scoring — best UNDER play in MLB today" }, { label: "SEA Pitching", impact: "medium", direction: "positive", value: "-199 home favorite", description: "Mariners backed by strong rotation at home" }], riskFactors: [], reasoning: "SEA -199 confirmed. T-Mobile Park is a graveyard for offense — model projects 7.2 vs 7.5 line. Best MLB UNDER today.", createdAt: new Date().toISOString().slice(0,10) + "T14:00:00.000Z" } },
];
